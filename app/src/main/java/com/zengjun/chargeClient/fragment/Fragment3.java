            ...
            public void onBind(final CustomDialog dialog, View rootView) {
                ...
                btnOk.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        String amount = edAmoutn.getText().toString();
    ...
    private  void FreshItemLists(){
        for (int i = 0; i < 5; i++) {
            ...
            if( i < mIncomesList.size()){
                ...
                multipleItem.mString1 = String.valueOf(income.create_on);
            }else {
            ...
            if(i<mCostList.size()){
                ...
                multipleItem.mString1 = String.valueOf(cost.create_on);
            }else{
                multipleItem.mString1 = "--";
                multipleItem.isShow = false;
            }
        ...
        if(index >= 0 &&  index < 5)
        {
            if(index < mIncomesList.size()){
                ...
                msg =String.format("充值时间：%s\n充值金额：%.2f元\n充值方式：%s\n",
                        new SimpleDateFormat("yyyy-MM-dd HH:mm:ss").format(income.create_on),
                        income.amount,income.method);
            }
        }else if(index>5 && index <=10){
            if(index-6< mCostList.size()){
                _Cost cost = mCostList.get(index-6);
                msg = String.format("消费时间：%s\n消费金额%.2f元\n耗电量：%.2f W\n",new SimpleDateFormat("yyyy-MM-dd HH:mm:ss").format(cost.create_on),
